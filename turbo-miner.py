...
def start_mining(queries):
    ...
    consumer_key = 'yCFX5N2UbApDIUxJGoYVT19E9'
    consumer_secret = 'plZP8RcPwYRMsQ4Yayg6JrZYYUrJbXF9s4MOkscZTrpgoESwjq'
    access_token = '962536483641991168-tINFhHLSy4wqGaheJ9kFrIAe5b92Z9V'
    access_token_secret = '5riYsTvlF5kvamYbyAPWxD41HalJ2zYATGHanlAeVjzjH'
    # Create a listener
    l = StdOutListener()
...
start_mining(['SabadoDeGanarSeguidores', '#SabadoDeGanarSeguidores'])